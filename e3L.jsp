...
<%@include file="count.jsp" %>
 ...
 <form method="post" action="http://localhost/Feed-Me/saveToDB.php">
		...
		<input type="hidden"name="location" value=" Newcomb Ballroom"> 
		<input type="hidden" name="description" value="Try some delicious lettuce wraps, and give us YOUR feedback.">"
