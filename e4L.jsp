...
<body>
	...
	<center>
		<div id="main" class="eventSquare"
			...
			<div id="main" class="eventContent">
				...
				<p style="">
					<b>Host</b>: UVA Tea Society<br> <b>Location</b>: New Cabell
					Hall (Room 214) <br> <b>Description</b>: Green tea is
					delicious, so you should come. Try matcha-infused cupcakes, ice
					cream, and more!
				</p>
			</div>
	...
	<form method="post" action="http://localhost/Feed-Me/saveToDB.php">
		...
		<input type="hidden" name="description" value="Green tea is delicious, so you should come. Try matcha-infused cupcakes, ice cream, and more!">"
