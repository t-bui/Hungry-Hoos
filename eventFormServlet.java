...
public class eventFormServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			out.println(
					"<div id = 'main'  style='display:flex;justify-content:center;align-items:center;color:EAF2F8'>");
			...
			out.println("<form name='confirm' action= 'browse.html' class='centered' >");
